...
<html>
    <head>
		...
		<?php 
			if($_SERVER["REQUEST_URI"] == "/delivery/order.php"){
				echo '<script src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.min.js"></script>';
        		echo '<script src="https://cdn.jsdelivr.net/npm/jquery.maskedinput@1.4.1/src/jquery.maskedinput.min.js" type="text/javascript"></script>';
			}
		?>
    ...
    <body>
        <header>
            <div class="wrapper">
                <div class="container">
                    <a href="http://localhost/delivery/" class="logo">
				...
				c-5.9-40.6-24.7-75.7-54.6-102.3l11.6-14.7c33.4,29.8,55.4,71.1,61.4,115.3L444.662,715.727z"/>
                   ...
                   pizza<br>delivery
                    ...
                    <div class="header__nav">
                        ...
                        <a href="http://localhost/delivery/pizza.php" class="header__nav--item">Пицца</a>
                        <a href="#" class="header__nav--item">Конструктор Пиццы</a>
                    ...
                    <div class="header__btn--container">
                        <div class="header__btn cart">
                            ...
                            <span><?php if(isset($_SESSION["cart_list"])){ echo count($_SESSION["cart_list"]);} else {echo "0";}  ?></span>
                        </div>
                        <a href="http://localhost/delivery/admin.php" class="header__btn cab">
                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="about"><path fill="#fff" d="M16,16A7,7,0,1,0,9,9,7,7,0,0,0,16,16ZM16,4a5,5,0,1,1-5,5A5,5,0,0,1,16,4Z"/><path fill="#fff" d="M17,18H15A11,11,0,0,0,4,29a1,1,0,0,0,1,1H27a1,1,0,0,0,1-1A11,11,0,0,0,17,18ZM6.06,28A9,9,0,0,1,15,20h2a9,9,0,0,1,8.94,8Z"/></g></svg>
                        </a>
                    </div>
