...
if($terms == "empty"){
    post_loop_catalog($mysqli);
} else {
    $sql = "SELECT DISTINCT product.* FROM product INNER JOIN product_cat ON product.id = product_cat.product_id WHERE product_cat.category_id IN $terms";
